<%@page import="VAKS.run.Controller.VolunteerController"%>
...
<head>
<meta charset="UTF-8">
<title><%=LoginController.getLoggedInUsername()%> | Volunteer | VAKS</title>
</head>
<style>
body {
 ...
 <div class="elfsight-app-82714bd8-9800-40e3-96be-879a60a0aff2"></div>
				...
				<div id="User">
					...
					<div class="page-wrap">
						...
						<div class="scrollit">
							<form action="Volunteer/deleteUser" method="post">
...
// 								System.err.println(id);
					...
					<div class="page-wrap">
						...
						<div class="form-popup" id="myForm">
							<form action="Volunteer/createEvent" class="form-container" method="post">
...
<!-- 								<label for="public">For All</label>  -->
								<input type="radio" id="special" name="privacy" value="Special" onclick="enableUserSelect()" checked="checked">
								<label for="private">For Special</label><br> 
								<label for="user"><b>User</b></label> 
								<select name="forUser" id="forUser" required>
									<%
									ResultSet r4 = null;
																String Query4 = "Select user_id, first_name, last_name From User Natural Join User_Role Natural Join Role Natural Join  Residence_Permit Natural Join User_Residence_Permit Natural Join Mother_Language Natural Join User_Mother_Language Natural Join Address Natural Join User_Address ORDER By role_id, user_id;";
				...
				<div id="ManageEvents">
					...
					<div class="form-popup" id="myForm2">
							<form action="Volunteer/editEvent" class="form-container" method="post">
...
<!-- 								<label for="public">For All</label>  -->
							...
							<form action="Volunteer/showEvents" method="post">
							
								<label>Search By Date</label>
								<input type="date" name="search" id="myDate"  value= "<%=VolunteerController.defaultDate%>" onchange="this.form.submit()">
								<br> <br>
						...
						<div class="scrollit">
								...
								<form action="Volunteer/deleteEvent" method="post">							
								<table id="EventTable" class="table table-bordered">
									...
									<tbody>
										<%
										if (VolunteerController.find.equals("basic")) {
																			
																		} else if (VolunteerController.find.equals("byUser")) {

																			ResultSet r10 = null;
																			String Query10 = "Select DISTINCT event_id, event_name, from_date, to_date, from_time, to_time, location, user_id, first_name, last_name, created_by_user_id From Event  Natural Join User_Event Natural Join User Where for_user_id = '"
																			+ VolunteerController.searchBy + "' AND user_id=for_user_id;";
																			Statement s10 = null;
																			...
																			while (r10.next()) {
																				...
																				if(created_by_user_id.equals(LoginController.getLoggedInUserId())) {
										%>
			...
			<!-- 											<td><button onclick="openForm()">Edit1</button></td> -->
													...
													<%
																					...
																					r10.close();
																					s10.close();
																					} else if (VolunteerController.find.equals("byDate")) {
																					
																					// To show Events for Users by Date
																					ResultSet r10 = null;
																					String Query10 = "Select DISTINCT event_id, event_name, from_date, to_date, from_time, to_time, location, user_id, first_name, last_name, created_by_user_id From Event  Natural Join User_Event Natural Join User Where from_date = '"
																							+ VolunteerController.searchBy + "' AND user_id=for_user_id;";
																					Statement s10 = null;
																					s10 = AppWithDB.connect().createStatement();
																					r10 = s.executeQuery(Query10);
										...
										%>
											...
											<%
																			...
																			ResultSet r11 = null;
																			String Query11 = "Select DISTINCT event_id, event_name, from_date, to_date, from_time, to_time, location, created_by_user_id From Event  Natural Join User_Event Natural Join User Where from_date = '"+ VolunteerController.searchBy +"' and for_user_id ISNULL;";
																			Statement s11 = null;
																			...
																			String created_by_user_id = r11.getString("created_by_user_id");
				...
				<div id="Documents">
					...
					<form action="Volunteer/searchByUser_Document" method="post">
						...
						<div class="scrollit">
							<form action="Volunteer/deleteDocument" method="post">
								<table id="DocumentTable" class="table table-bordered">
									...
									<tbody>
										<%
										if(VolunteerController.documentSearch.equals("empty")){
																			
																			
																		}
																		else if (VolunteerController.documentSearch.equals("-- Public Documents --")) {
										...
										%>
													...
													%>
														...
														<%
																						...
																						} else if (VolunteerController.documentSearch.equals("-- My Documents --")) {
													...
													<%
																					...
																					} else if (VolunteerController.documentSearch.equals("-- All Documents --")) {
																						
																						ResultSet r2 = null;
																						String Query2 = "Select document_id, document_name, document_language, Type.document_type, document_for_user, User_Document.user_id FROM Document NATURAL JOIN Type Natural JOIN Document_Type Natural Join User_Document ORDER BY Type.document_type DESC;";
																						Statement s2 = AppWithDB.connect().createStatement();
																						r2 = s2.executeQuery(Query2);
																						while (r2.next()) {
																							String document_id = r2.getString("document_id");
													...
													<%
																						...
																						ResultSet r222 = null;
																						String Query222 = "Select document_id, document_name, document_language, Type.document_type, document_for_user, User_Document.user_id FROM Document NATURAL JOIN Type Natural JOIN Document_Type Natural Join User_Document where User_Document.document_for_user='" + VolunteerController.documentSearch + "';";
																						...
																						while (r222.next()) {
																							...
																							String user_id = r222.getString("user_id");
						...
						<form action="Volunteer/uploadDocument" method="post" enctype="multipart/form-data">
