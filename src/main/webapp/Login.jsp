...
.login-container {
	...
	min-height: 680px;
	background-image:
		url(https://www.heimatverein-altenkirchen.de/bilder/impressionen/rathaus_betzdorf.jpg);
...
<body>
	...
	<form action="Login" class="form-login" method="post">
		...
		<input name="password" id="login-input-password" class="login__input" type="password" required="required" />
		
		<br><br><br><br>
		
		<button type="submit" class="login__submit">Login</button>
	</form>
	<a href="http://localhost:8081/Project2/ForgetPassword.jsp" class="login__forgot">Forget Password?</a>
</div>
