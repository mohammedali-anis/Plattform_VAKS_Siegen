<%@page import="VAKS.run.Controller.WorkerController"%>
...
<head>
<meta charset="UTF-8">
<title><%=LoginController.getLoggedInUsername()%> | Worker | VAKS</title>
</head>
<style>
body {
			...
			<div class="mainContent clearfix">
				...
				<div id="User">
					...
					<div class="page-wrap">
						...
						<div class="scrollit">
							<form action="Worker/deleteUser" method="post">
								<table id="UserTable" class="table table-bordered">
									...
									<tbody>
										...
										ResultSet r = null;
																		...
																		String Query = "Select user_id, first_name, last_name, country, language, residence_permit_type, email, street, number, post_code, city, role_type From User Natural Join User_Role Natural Join Role Natural Join  Residence_Permit Natural Join User_Residence_Permit Natural Join Mother_Language Natural Join User_Mother_Language Natural Join Address Natural Join User_Address  where user_id in ( Select kunde_id from Kunde_Supervised_By_Worker Natural Join User  where  worker_id=(Select user_id from User where username='"
																				+ LoginController.getLoggedInUsername() + "')) OR role_type='Volunteer';";
						...
						<!--  Scroll Div -->
						<form action="Worker/AddUser" method="post">
				...
				<div id="Calendar">
					...
					<div class="page-wrap">
						...
						<div class="form-popup" id="myForm">
							<form action="Worker/createEvent" class="form-container" method="post">
								...
								<label for="private">For Special</label><br> <label
									...
									<%
									ResultSet r4 = null;
																String Query4 = "Select user_id, first_name, last_name, country, language, residence_permit_type, email, street, number, post_code, city, role_type From User Natural Join User_Role Natural Join Role Natural Join  Residence_Permit Natural Join User_Residence_Permit Natural Join Mother_Language Natural Join User_Mother_Language Natural Join Address Natural Join User_Address  where user_id in ( Select kunde_id from Kunde_Supervised_By_Worker Natural Join User  where  worker_id=(Select user_id from User where username='"
																		+ LoginController.getLoggedInUsername() + "')) OR role_type='Volunteer';";
				...
				<div id="ManageEvents">
					...
					<div class="form-popup" id="myForm2">
							<form action="Worker/editEvent" class="form-container" method="post">
								...
								<select name="forUser" id="forUser2" required disabled="disabled" >
									<%
									ResultSet r44 = null;
																String Query44 = "Select user_id, first_name, last_name, country, language, residence_permit_type, email, street, number, post_code, city, role_type From User Natural Join User_Role Natural Join Role Natural Join  Residence_Permit Natural Join User_Residence_Permit Natural Join Mother_Language Natural Join User_Mother_Language Natural Join Address Natural Join User_Address  where user_id in ( Select kunde_id from Kunde_Supervised_By_Worker Natural Join User  where  worker_id=(Select user_id from User where username='"
																		+ LoginController.getLoggedInUsername() + "')) OR role_type='Volunteer';";
							...
							<form action="Worker/showEvents" method="post">
							
								<label>Search By Date</label>
								<input type="date" name="search" id="myDate"  value= "<%=WorkerController.defaultDate%>" onchange="this.form.submit()">
								<br> <br>
								...
								<datalist id="brow">
													<%
													ResultSet r8 = null;
																								String Query8 = "Select user_id, first_name, last_name, country, language, residence_permit_type, email, street, number, post_code, city, role_type From User Natural Join User_Role Natural Join Role Natural Join  Residence_Permit Natural Join User_Residence_Permit Natural Join Mother_Language Natural Join User_Mother_Language Natural Join Address Natural Join User_Address  where user_id in ( Select kunde_id from Kunde_Supervised_By_Worker Natural Join User  where  worker_id=(Select user_id from User where username='"
																										+ LoginController.getLoggedInUsername() + "')) OR role_type='Volunteer';";
						...
						<div class="scrollit">
								...
								<form action="Worker/deleteEvent" method="post">							
								<table id="EventTable" class="table table-bordered">
									...
									<tbody>
										<%
										if (WorkerController.find.equals("basic")) {
																			
																		} else if (WorkerController.find.equals("byUser")) {
																			...
																			+ WorkerController.searchBy + "' AND user_id=for_user_id;";
																			Statement s10 = null;
...
<!-- 											<td><button onclick="openForm()">Edit1</button></td> -->
										...
										<%
																		...
																		r10.close();
																		s10.close();
																		} else if (WorkerController.find.equals("byDate")) {
										...
										<%
																		...
																		ResultSet r11 = null;
																		String Query11 = "Select DISTINCT event_id, event_name, from_date, to_date, from_time, to_time, location From Event  Natural Join User_Event Natural Join User Where from_date = '"+ WorkerController.searchBy +"' and for_user_id ISNULL;";
																		Statement s11 = null;
				...
				<div id="Documents">
					...
					<form action="Worker/searchByUser_Document" method="post">
								...
								<option value="-- All Documents --"></option>
													...
													<%
																					ResultSet r81 = null;
																																String Query81 = "Select user_id, first_name, last_name, country, language, residence_permit_type, email, street, number, post_code, city, role_type From User Natural Join User_Role Natural Join Role Natural Join  Residence_Permit Natural Join User_Residence_Permit Natural Join Mother_Language Natural Join User_Mother_Language Natural Join Address Natural Join User_Address  where user_id in ( Select kunde_id from Kunde_Supervised_By_Worker Natural Join User  where  worker_id=(Select user_id from User where username='"
																																		+ LoginController.getLoggedInUsername() + "')) OR role_type='Volunteer';";
						...
						<div class="scrollit">
							<form action="Worker/deleteDocument" method="post">
								<table id="DocumentTable" class="table table-bordered">
									...
									<tbody>
										<%
										if(WorkerController.documentSearch.equals("empty")){
																			
																			
																		}
																		else if (WorkerController.documentSearch.equals("-- Public Documents --")) {
										...
										%>
													...
													<tr>
														...
														<td style="color:green">-</td>
														<td ><a href="Worker/downloadDocument/<%=document_id%>">Download</a></td>
														<td ><input type="submit" Value="Delete"
													...
													<%
																					...
																					} else if (WorkerController.documentSearch.equals("-- My Documents --")) {
													...
													<%
																					...
																					} else if (WorkerController.documentSearch.equals("-- All Documents --")) {
													...
													<%
																								...
																								String sql = "Select user_id From User Natural Join User_Role Natural Join Role Natural Join  Residence_Permit Natural Join User_Residence_Permit Natural Join Mother_Language Natural Join User_Mother_Language Natural Join Address Natural Join User_Address  where user_id in ( Select kunde_id from Kunde_Supervised_By_Worker Natural Join User  where  worker_id=(Select user_id from User where username='" + LoginController.getLoggedInUsername() + "')) OR role_type='Volunteer';";
																								Statement st = AppWithDB.connect().createStatement();
																								...
																								System.out.println("Document for user : " + document_for_user);
																								System.out.println(users.contains(document_for_user));

																								if(users.contains(document_for_user)) {
													%>
													...
													<%
																						...
																						ResultSet r222 = null;
																						String Query222 = "Select document_id, document_name, document_language, Type.document_type, document_for_user FROM Document NATURAL JOIN Type Natural JOIN Document_Type Natural Join User_Document where User_Document.document_for_user='" + WorkerController.documentSearch + "';";
						...
						<form action="Worker/uploadDocument" method="post" enctype="multipart/form-data">
							<div class="AddDocument-container " id="AddDocument-container" style="visibility: hidden">
								...
								<datalist id="brow">
													<%
													ResultSet r9 = null;
																								String Query9 = "Select user_id, first_name, last_name, country, language, residence_permit_type, email, street, number, post_code, city, role_type From User Natural Join User_Role Natural Join Role Natural Join  Residence_Permit Natural Join User_Residence_Permit Natural Join Mother_Language Natural Join User_Mother_Language Natural Join Address Natural Join User_Address  where user_id in ( Select kunde_id from Kunde_Supervised_By_Worker Natural Join User  where  worker_id=(Select user_id from User where username='"
																										+ LoginController.getLoggedInUsername() + "')) OR role_type='Volunteer';";
...
<!-- 				</div> -->
	...
	<script>
		...
		function showHideBar(d) {
			...
			var divs = [ 'User', 'Calendar', 'Documents', 'ManageEvents' ];
